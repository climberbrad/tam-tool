    ...
    render() {
        return (
            <div>
                ...
                <div className="stat" onClick={() => this.props.click("overview")}>Member since <div className="org-data">{this.state.orgDetails.subscriptionStartsAt}</div></div>

                <div className="side-bar-header">AWS</div>
                <div className="stat" onClick={() => this.props.click("services")}>Servics <div className="org-data">{this.state.orgDetails.numAwsServices}</div></div>
                <div className="stat" onClick={() => this.props.click("accounts")}>Accounts<div className="org-data">{this.getLinkedAccountIdentifiers().length}</div></div>
